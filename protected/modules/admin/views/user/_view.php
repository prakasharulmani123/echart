...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('user_ip_addr')); ?>:</b>
	<?php echo CHtml::encode($data->user_ip_addr); ?>
	<br />

	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('created_client')); ?>:</b>
	<?php echo CHtml::encode($data->created_client); ?>
	<br />
